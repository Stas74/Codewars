...
We can see, if you just want to translate a number into a string representation,
 in the general case the results obtained in these ways is the same. I love to use the last one, cause I'm lazy ;-)
...
function colorOf(r, g, b) {
  return "#" + hexCheck(r.toString(16)) + hexCheck(g.toString(16)) + hexCheck(b.toString(16));
}
