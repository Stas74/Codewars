...
A certain number of points will be given for each correct answer and a certain number of points 
...
function scoreTest(str, right, omit, wrong) {
  return str.reduce((prev, cur) => prev + (cur == 0 ? right : cur == 1 ? omit : -wrong), 0);
}
