...
concat() can have more and more parameters, and the parameter can be values, array or otherthings. 
Look this example:
...
Here we look at some examples of join(). 
Its main purpose is to merge the elements of an array into a string, 
...
the use of the + operator speed is slow, the correct method should be to put them into the array, 
